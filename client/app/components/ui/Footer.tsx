    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-4">
            ...
            <p className="mt-4 text-gray-400 max-w-md">
              Your personal library, reimagined. Discover, organize, and share your love for books.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <Link href="#features" className="text-base text-gray-400 hover:text-white transition-colors duration-300">
                      Features
                    </Link>
                  </li>
                  <li>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-base text-gray-400">&copy; 2025 Librora, Inc. All rights reserved.</p>
